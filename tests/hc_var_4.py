...
# Stiffener layouts
stifflayout1 = StiffenerLayout(1, initial_stiffener, "spacing", 0.724)
stifflayout2 = StiffenerLayout(2, initial_stiffener, "spacing", 0.7)
stifflayout3 = StiffenerLayout(3, initial_stiffener, "spacing", 0.64)

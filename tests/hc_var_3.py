...
Grillage.set_plating_prop_symmetric(hc_var_3, 2, "stiff_dir", BeamOrientation.LONGITUDINAL)
...
GrillageModelData('../grillage savefiles\\hc_var_3_savefile.txt').write_file(hc_var_3)
